...
using RegistradorDeCobranca.MicroservicesCommunication.Clientes;
using RegistradorDeCobranca.MicroservicesCommunication.Cobrancas;
using RegistradorDeCobranca.Services;
using RegistradorDeCobranca.Services.ConsumptionCalculator;
using RegistradorDeCobranca.Swagger;
...
namespace RegistradorDeCobranca
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "RegistradorDeCobranca", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "RegistradorDeCobranca v1");
